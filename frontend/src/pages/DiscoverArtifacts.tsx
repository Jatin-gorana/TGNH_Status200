...
//                 <button
//                   onClick={startCamera}
//                   className="mt-6 bg-blue-600 text-white px-6 py-2 rounded-lg flex items-center justify-center hover:bg-blue-700 transition-colors"
//                 >
//                   <FaCamera className="mr-2" />
//                   Capture Artifact Image
//                 </button>
...
//       {structuredResult && (
//         <section className="py-6 bg-stone-900 text-white">
//           <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
//             <h2 className="text-3xl font-serif mb-8 text-center">
//               Analysis Result
//             </h2>
